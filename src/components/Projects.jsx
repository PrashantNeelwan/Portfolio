  ...
  return (
    <section>
      ...
      <div className="card">
        ...
        <img src="../../public/Screenshot 2026-01-28 123934.png" alt="AI-OPS Illustration" style={{ width: '100%', height: 'auto' }} />
        <p>
...
Designed a cloud-native architecture with React dashboards, Node.js APIs, workflow orchestration, and deterministic AI validation for production-safe automation.
      ...
      <div className="card">
        ...
        <img src="../../public/BlockChain Architecture.png" alt="AI-OPS Illustration" style={{ width: '100%', height: 'auto' }} />
...
Implemented smart contracts, REST APIs, authentication, and cloud deployment with an AI-assisted risk-scoring approach for fraud detection and credit assessment.</p>
      ...
      <div className="card">
        ...
        <img src="../../public/QuantumTrade.png" alt="AI-OPS Illustration" style={{ width: '100%', height: 'auto' }} />
